...
<br>
📨 Hemos recibido tu solicitud de traslado. Estamos trabajando en ella y en breve recibirás confirmación.<br>
<br>
🔖 Tu número de reserva es:<br>
...
<span style="font-size:13px;color:#888;">💾 Guarda este número — lo necesitarás para consultar el estado de tu reserva. Nos pondremos en contacto contigo a través del WhatsApp o email que nos has facilitado.</span><br>
<br>
<span style="font-size:13px;color:#888;">⏱️ El plazo máximo para confirmarte un conductor es de 15 minutos. Te avisaremos en cuanto tengamos una respuesta.</span><br>
<br>
...
Hola, <strong>{nombre_cliente}</strong> 👋<br>
<br>
✅ <strong>¡Tu traslado está confirmado!</strong> Hemos asignado un conductor para tu servicio.<br>
<p style="text-align:center;margin:20px 0;">
...
{boton_pago}
<span style="font-size:13px;color:#888;">📲 Nos pondremos en contacto contigo por WhatsApp para coordinar todos los detalles del servicio.</span><br>
<br>
Un saludo cordial, 🙏<br>
<strong>El equipo de Traslados GC</strong>
`,
...
Hola, <strong>{nombre_cliente}</strong> 👋<br>
<br>
💳 Te reenviamos el enlace de pago para confirmar tu reserva <strong>{numero_reserva}</strong>.<br>
{boton_pago}
<span style="font-size:13px;color:#888;">❓ Si tienes algún problema con el pago, contacta con nosotros por WhatsApp.</span><br>
<br>
Un saludo cordial, 🙏<br>
<strong>El equipo de Traslados GC</strong>
`,
...
Hola, <strong>{nombre_cliente}</strong> 👋<br>
<br>
📄 Adjuntamos el voucher de tu traslado <strong>{numero_reserva}</strong>. Llévalo contigo el día del servicio.<br>
<br>
<span style="font-size:13px;color:#888;">❓ Si tienes cualquier duda, no dudes en contactarnos por WhatsApp.</span><br>
<br>
Un saludo cordial, 🙏<br>
<strong>El equipo de Traslados GC</strong>
`,
...
Hola, <strong>{nombre_cliente}</strong> 👋<br>
<br>
❌ Tu reserva <strong>{numero_reserva}</strong> ha sido cancelada correctamente.<br>
<div class="info-box">
...
{aviso_deposito}
❓ Si tienes alguna duda, puedes contactarnos por WhatsApp.<br>
<br>
Un saludo cordial, 🙏<br>
<strong>El equipo de Traslados GC</strong>
`,
...
Hola, <strong>{nombre_cliente}</strong> 👋<br>
<br>
✅ Hemos revisado y aprobado los cambios en tu reserva <strong>{numero_reserva}</strong>.<br>
<br>
🔍 Accede a tu portal para ver todos los detalles actualizados.<br>
<br>
Un saludo cordial, 🙏<br>
<strong>El equipo de Traslados GC</strong>
`,
...
Hola, <strong>{nombre_cliente}</strong> 👋<br>
<br>
💬 El equipo de Traslados GC te ha enviado un mensaje sobre tu reserva <strong>{numero_reserva}</strong>:<br>
<blockquote>{mensaje}</blockquote>
🔍 Accede a tu portal para ver el hilo completo y responder.<br>
<br>
Un saludo cordial, 🙏<br>
<strong>El equipo de Traslados GC</strong>
`,
...
Hola, <strong>{nombre_cliente}</strong> 👋<br>
<br>
🏁 Tu traslado ha finalizado. Nos gustaría saber cómo fue tu experiencia.<br>
<div class="info-box">
  🗺️ <strong>{origen} → {destino}</strong><br>
  <span style="font-size:13px;color:#888;">🔖 Reserva {numero_reserva} · 📅 {fecha}</span>
</div>
⭐ Tu opinión nos ayuda a seguir mejorando el servicio. Solo te llevará un momento.<br>
{boton_valoracion}
<span style="color:#888;font-size:13px;"><em>Si no fuiste tú quien realizó este traslado, puedes ignorar este mensaje.</em></span><br>
<br>
Un saludo cordial, 🙏<br>
<strong>El equipo de Traslados GC</strong>
`,
...
🙏 Ha sido un placer acompañarte en este viaje. Si en algún momento necesitas otro traslado en Gran Canaria, estaremos encantados de ayudarte.<br>
<br>
Un saludo cordial, 🙏<br>
<strong>El equipo de Traslados GC</strong>
`,
...
❓ Si crees que ha habido un error, no dudes en contactarnos.<br>
<br>
Un saludo cordial, 🙏<br>
<strong>El equipo de Traslados GC</strong>
`,
...
Hola, <strong>{nombre_cliente}</strong> 👋<br>
<br>
🔄 Seguimos trabajando en tu solicitud de traslado <span class="pnr">{numero_reserva}</span>. Aún no hemos podido confirmar conductor, pero continuamos buscando disponibilidad.<br>
<div class="info-box">
...
Hola, <strong>{nombre_cliente}</strong> 👋<br>
<br>
😔 Lamentamos informarte que no hemos podido confirmar un conductor disponible para tu traslado en la fecha solicitada, por lo que hemos anulado la reserva <span class="pnr">{numero_reserva}</span>.<br>
<div class="info-box">
...
Hola, <strong>{nombre_cliente}</strong> 👋<br>
<br>
🔐 Aquí tienes tu contraseña provisional para acceder al seguimiento de tu reserva <span class="pnr">{numero_reserva}</span>.<br>
...
<span style="font-size:13px;color:#5b5347;">⚠️ Al entrar por primera vez se te pedirá que la cambies por una propia.</span><br>
<br>
<span style="font-size:12px;color:#aaa;"><em>Si no has solicitado este acceso, ignora este mensaje.</em></span><br>
<br>
Un saludo cordial, 🙏<br>
<strong>El equipo de Traslados GC</strong>
`,
...
Hola, <strong>{nombre_cliente}</strong> 👋<br>
<br>
🔑 Has solicitado recuperar el acceso a tu cuenta. Pulsa el botón para elegir una contraseña nueva:<br>
<p style="text-align:center;">
  <a href="{enlace_recuperacion}" class="boton">Crear nueva contraseña</a>
</p>
<span style="font-size:13px;color:#5b5347;">⏱️ Este enlace caduca en 1 hora y solo se puede usar una vez. Tu contraseña actual sigue funcionando hasta que la cambies desde aquí.</span><br>
<br>
<span style="font-size:12px;color:#aaa;"><em>Si no has solicitado esto, simplemente ignora este mensaje — no se cambiará nada.</em></span><br>
<br>
Un saludo cordial, 🙏<br>
<strong>El equipo de Traslados GC</strong>
`,
...
Hola, <strong>{nombre_cliente}</strong> 👋<br>
<br>
✅ Ya tenemos el precio para tu traslado.<br>
<div class="info-box">
  📍 <strong>Ruta:</strong> {origen} → {destino}<br>
  💰 <strong>Precio estimado:</strong> <span style="font-size:16px;font-weight:700;color:#C1502E;">{precio} €</span>
</div>
👉 Si deseas proceder con la reserva, visita nuestra web o respóndenos por WhatsApp y lo gestionamos enseguida.<br>
<br>
Un saludo cordial, 🙏<br>
<strong>El equipo de Traslados GC</strong>
`,
...
Hola, <strong>{nombre_cliente}</strong> 👋<br>
<br>
😔 Hemos revisado tu consulta para el traslado de <strong>{origen}</strong> a <strong>{destino}</strong> y lamentamos informarte que en este momento no podemos ofrecerte servicio para esa ruta o fecha.<br>
<div class="info-box">
...
Hola, <strong>{nombre_cliente}</strong> 👋<br>
<br>
📄 Adjuntamos la factura <strong>{numero_factura}</strong> correspondiente a tu reserva <strong>{numero_reserva}</strong>.<br>
<br>
🙏 Gracias por viajar con Traslados GC.<br>
<br>
Un saludo cordial, 🙏<br>
<strong>El equipo de Traslados GC</strong>
`,
